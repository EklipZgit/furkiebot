  ...
  ?>
	<div class="skinny">
			...
			<p>Forgot your SpeedRunsLive identify password? You will need to follow their instructions for resetting below:</p>
				...
				<div class="well">
				<p>If you forgot your password, you can request an e-mail with instructions to reset it using <br>"/nickserv resetpass (nickname)". The e-mail may be filtered by your spam filter.</br></p>
