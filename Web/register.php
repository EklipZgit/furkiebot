...
<html lang="en">
<head>
	<title>Register with Furkiebot</title>
	<!-- Bootstrap core CSS -->
	...
	<div class="skinny">
		...
		<div id="main">
			...
			<p>All you need to do is 
				...
				<br><br>Then, once you are "Identified" with NickServ, you will need to register with FurkieBot. 
