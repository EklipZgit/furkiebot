...
if (isTester()) {
	...
	echo '<p>If you wish to become a tester, click <a href="http://eklipz.us.to/cmr/becometester.php">HERE</a>. Warning: Once you become a tester, you cannot participate in the upcoming CMR. This is non-reversable. You will no longer be a tester after this CMR.</p>';
} else {
